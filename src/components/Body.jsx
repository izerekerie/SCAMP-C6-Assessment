  ...
  return (
    <>
         ...
         <div className='md:w-1/2  md:p-12'>
           ...
           <div className='w-11/12 flex p-4 justify-between'>
              {images.map((img)=>{return(
                <img onClick={()=>setCurrent(img.source)} className='w-20 h-20 rounded active:border-2 active:border-orange-500 active:opacity-50 ' src={img.source}/>
              )})}
           </div>
         ...
         <div className="md:flex mt-12 ">
          <div className="flex my-4 justify-evenly p-4 mx-4 md:w-1/4 bg-gray-200 rounded ">
          
           <img className='w-4' src={minus} alt="" />
           <p className='font-bold text-sm'>0</p>
           <img  className='w-4' src={plus} alt="" />
          </div>
          <div className="flex my-4 justify-evenly p-4 mx-4 rounded md:w-1/4" style={{backgroundColor:'#ff7c1a'}}>
